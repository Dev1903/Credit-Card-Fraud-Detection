Here, an HTML file `index.html` is created where the features required for checking the credit card authenticity is to be entered and the result will be printed in the HTML file itself
